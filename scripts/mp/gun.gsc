...
maps\mp\gametypes\gun::guninfo("h2_mp7", "none", smg_additional_attachments);
maps\mp\gametypes\gun::guninfo("h2_deserteagle", "tacknifedeagle");
maps\mp\gametypes\gun::guninfo("h2_mp412", "none", shotgun_additional_attachments_akimbo);
maps\mp\gametypes\gun::guninfo("h2_pm9", "none", smg_additional_attachments);
maps\mp\gametypes\gun::guninfo("h2_l118a", "none", snipers_additional_attachments);
...
maps\mp\gametypes\gun::guninfo("h2_pkm", "none", lmg_additional_attachments);
maps\mp\gametypes\gun::guninfo("h2_p90", "none", smg_additional_attachments);
maps\mp\gametypes\gun::guninfo("h2_as50", "none", snipers_additional_attachments);
maps\mp\gametypes\gun::guninfo("h2_ak74u", "none", smg_additional_attachments);
maps\mp\gametypes\gun::guninfo("h2_fmg9", "akimbo",shotgun_additional_attachments_akimbo);
maps\mp\gametypes\gun::guninfo("h2_fal", "reflex", ar_additional_attachments);
maps\mp\gametypes\gun::guninfo("h2_masada", "thermal", ar_additional_attachments);
...
maps\mp\gametypes\gun::guninfo("h2_scar", "glpre","gl");
maps\mp\gametypes\gun::guninfo("h2_aac", "acogiw6");
maps\mp\gametypes\gun::guninfo("h2_usr", "none", snipers_additional_attachments);
maps\mp\gametypes\gun::guninfo("h2_m240", "foregrip", lmg_additional_attachments);
maps\mp\gametypes\gun::guninfo("h2_mp5", "mp5silencer");
maps\mp\gametypes\gun::guninfo("h2_mors", "morsscope");
maps\mp\gametypes\gun::guninfo("h2_rpg", "camo009");		
