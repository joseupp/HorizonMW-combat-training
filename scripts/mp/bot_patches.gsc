...
bot_killstreak_setup_stub()
{
	if (!isdefined(level.killstreak_botfunc))
	{
		...
		bot_register_killstreak_func("ah6_mp", maps\mp\bots\_bots_ks::bot_killstreak_simple_use, ::bot_killstreak_do_use);
		bot_register_killstreak_func("advanced_uav_mp", maps\mp\bots\_bots_ks::bot_killstreak_simple_use, ::bot_killstreak_do_use);
		bot_register_killstreak_func("reaper_mp", maps\mp\bots\_bots_ks::bot_killstreak_simple_use, ::bot_killstreak_do_use);
	}
}
