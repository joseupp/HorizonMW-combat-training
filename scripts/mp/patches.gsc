...
{
    if (scripts\mp_patches\common::is_not_h1_map())
    {
...
{
    if ( team == "africa" )
        model = "prop_flag_africa";
    else if( team == "rangers" )
        model = "prop_flag_rangers";
    else if( team == "pmcmw3" )
        model = "prop_flag_pmc";
    else if( team == "seals" )
        model = "prop_flag_seals";
    else
        model = tablelookup( "mp/factionTable.csv", 0, team, 10 );
		
    precacheModel( model );
	
    level.flagmodels[team] = [];
    level.flagmodels[team]["friendly"] = model;
    level.flagmodels[team]["enemy"] = model;
...
precacheflags_stub()
{
    ...
    map_h2m_team_to_h1("delta", "marines");
    map_h2m_team_to_h1("ic", "opfor");
    map_h2m_team_to_h1("gign", "marines");
    map_h2m_team_to_h1("africa", "opfor");
    map_h2m_team_to_h1("pmcmw3", "marines");
}
