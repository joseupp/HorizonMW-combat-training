vl_main()
{
    ...
    replacefunc(maps\mp\_vl_camera::updatecameracac, ::updatecameracac_stub);
}

updatecameracac_stub( var_0, var_1, var_2, var_3 )
{
    ...
    var_0.cut = 1;
    var_0 maps\mp\_vl_camera::cammove( var_5 );
    var_0 maps\mp\_vl_camera::camrotate( var_6 );
    var_0.location = "cac";
    maps\mp\_vl_camera::updatecamerafinish( var_0 );
}
...
weapons_init_stub()
{
    ...
    level.fastsprintrecoverytime = 3.0;
...
_setperk_stub(perk_name, var_1, var_2)
{
    ...
    if (perk_name == "specialty_quickswap")
    {
        class_index = maps\mp\_utility::getclassindex(self.pers["class"]);
        should_use_iw4_soh = self getcacplayerdata(class_index, "use_iw4_soh");

        if (should_use_iw4_soh)
            perk_name = "specialty_fastreload";
    }
...
handleweaponhighlighted_stub( var_0 )
{
    ...
    if ( var_2.size > 1 )
    {
        ...
        if ( var_7 == "specialty_blastshield" )
            thread maps\mp\_vl_cac::setcacweapon( "none", "Equipment" );
        else if( var_7 == "specialty_tacticalinsertion" )
            thread maps\mp\_vl_cac::setcacweapon( "flare_mp", "Equipment" );
        else
