...
-- -------------------------------------------------------------------------- --
local customcolor = {
    r = Engine.GetDvarFloat("hud_color_r"),
    g = Engine.GetDvarFloat("hud_color_g"),
    b = Engine.GetDvarFloat("hud_color_b")
}
...
--                                 Background                                 --
-- -------------------------------------------------------------------------- --
CoD.Material.LoadingAnim = "hmw_loading_animation"
