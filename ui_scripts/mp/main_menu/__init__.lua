...
--        end
    ...
    function menu_xboxlive(menu, args)
        ...
        local CombatTraining = menuTemplate:AddButton("COMBAT TRAINING ^:4XP", function(a1) --@MENU_GAME_TYPES
            LUI.FlowManager.RequestAddMenu(a1, "menu_xboxlive_lobby", true, nil)
            Engine.Exec("xstartlobby")
        end)
        CombatTraining:setDisabledRefreshRate(500)

--      local FindGameButton = menuTemplate:AddButton( "@PLATFORM_FIND_GAME", OnPublicMatch, disablePublicMatchButton )
