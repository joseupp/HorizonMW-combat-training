...
current_sensitivity = Engine.GetDvarFloat( "sensitivity" )
in_predator = false
...
local ui_predator_enabled = function(f4_arg0, f4_arg1)
    ...
    if Game.GetOmnvar("ui_predator_enabled") then
        if in_predator == false then
        current_sensitivity = Engine.GetDvarFloat( "sensitivity" )
        Engine.SetDvarFloat( "sensitivity", 6.0 )
        in_predator = true
        end
        ...
        if in_predator == true then
        Engine.SetDvarFloat( "sensitivity", current_sensitivity )
        in_predator = false
        end
