...
LUI.MenuBuilder.m_types_build["experienceBar"] = function()
    local state = CoD.CreateState( -11, nil, 21, 23, CoD.AnchorTypes.BottomLeftRight )
	...
	local background = CoD.CreateState( -970, -12, 12, 0, CoD.AnchorTypes.All )
	background.material = RegisterMaterial( "h2m_hud_as_kbm_blur" )
	background.alpha = 1
	f7_local3:addElement( LUI.UIImage.new( background ) )

	local backgroun2 = CoD.CreateState( 0, 0, 7, 0, CoD.AnchorTypes.All )
	backgroun2.material = RegisterMaterial( "black" )
	backgroun2.alpha = 0.1
	f7_local3:addElement( LUI.UIImage.new( backgroun2 ) )
	...
	local leftRankState = CoD.CreateState( 0, 0, nil, -5, CoD.AnchorTypes.TopBottomLeft )
	...
	local rightRankState = CoD.CreateState( nil, 0, -10, -5, CoD.AnchorTypes.TopBottomRight )
	...
	rightRank:registerAnimationState( "hidden", {alpha = 0} )
