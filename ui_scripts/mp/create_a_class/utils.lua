...
Cac.SetCacConfig = function ( controller, classType, f15_arg2, equipment, index, itemID, f15_arg6, f15_arg7 )
	...
	elseif f15_arg6 ~= nil then
        if itemID == "kit" and f15_arg6 == "furnitureKit" then
            return true
        end
        local success, result = pcall(Engine.SetPlayerData, controller, CoD.GetStatsGroupForGameMode(), classType, f15_arg2, equipment, index, itemID, f15_arg6)
        if not success then
            return false
        end
        return result
